...
class OpenFDAClient():
    ...
    def send_query(self, query):
        # We request an information to the API, it will return the result of the query in JSON format.
        ...
        if query:
            url += "?" + query
        print("Sending to OpenFDA the query", url)
...
class OpenFDAParser():
    ...
    def parse_companies(self, drugs):
        ...
        #We create an empty list to be full-filled
        companies = []
        for drug in drugs:
    ...
    def parse_warnings(self, drugs):
        ...
        # We extract the warnings info of the drug
        warnings = []
...
class testHTTPRequestHandler(http.server.BaseHTTPRequestHandler):
    ...
    def do_GET(self):
        ...
        # Write content as utf-8 data (binary (amplied for global languages) language
